...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        super().__init__(master=master)
        master.geometry("300x245")
        master.title("ICARE Account Login")
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="ICARE bot", bg="PeachPuff2", width="300", height="2", font=("Calibri", 13))
        self.lblMsg.pack()
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Maloth Prabhas", bg="RoyalBlue1", width = "230", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Md.Aquib Nazri", bg="RoyalBlue2", width = "230", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Swapnil Ch", bg="RoyalBlue2", width = "230", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="PeachPuff2")
        self.lblMsg.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Create login", bg="PeachPuff2")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=1, bg="PeachPuff2", command=self.register_user)
        self.btnRegister.pack()
