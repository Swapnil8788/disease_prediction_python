...
#    register_screen = Toplevel(main_screen)
    ...
    Label(register_screen, text="Please enter the details below", bg="PeachPuff2").pack()
    ...
    password_entry.pack()
    Label(register_screen, text="").pack()
    Button(register_screen, text="Register", width=10, height=1, bg="PeachPuff2", command=register_user).pack()
...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Choose", bg="green", width="300", height="2", font=("Calibri", 13)).pack()
    Label(main_screen,text="").pack()
    Button(main_screen,text="Login", height="2", width="30", command=login).pack()
    Label(main_screen,text="").pack()
    Button(main_screen,text="Create account", height="2", width="30", command=register).pack()
